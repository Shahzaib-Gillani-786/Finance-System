    ...
    obj.forEach(element => {
        ...
        <td>${element.amount}</td>
            ...
            <td>
                      ...
                      onClick="onEdit(this)"    style="color: #ffffff; text-decoration:
                      none;" class="p-1 " href="#">
                      <i class="fa fa-edit"></i>
                      </a>
                      </button>
                      <button type="button" class="btn btn-danger"><a  style="color: #ffffff; text-decoration:
                      none;" class="p-1" href=""><i class="fa fa-trash"></i> </a></button>
                    </td>
